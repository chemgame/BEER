...
# Monoisotopic residue masses (Da) — full-precision Unimod values
...
_ENZYME_RULES: dict[str, tuple[str, str]] = {
    ...
    "Lys-C":                ("after",  r"K(?!P)"),   # Jekel 1983: reduced cleavage before P
    "Asp-N":                ("before", r"[DE]"),      # cleaves before D (primary) and E (secondary)
    "Glu-C (pH 8)":         ("after",  r"[ED](?!P)"), # Houmard & Drapeau 1972: cleaves E and D at pH 8
    "Glu-C (pH 4)":         ("after",  r"[ED](?!P)"),
    "CNBr":                 ("after",  r"M"),
    "Arg-C":                ("after",  r"R(?!P)"),
}
