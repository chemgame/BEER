...
==========================
Amphipathic helix detection and hydrophobic moment calculation.

The hydrophobic moment (μH) was introduced by Eisenberg et al. (1984) as a
quantitative measure of amphipathicity.  High μH combined with moderate mean
hydrophobicity indicates an amphipathic α-helix, which is a structural feature
of many membrane-targeting and antimicrobial peptides.

References
----------
Eisenberg, D., Weiss, R.M. & Terwilliger, T.C. (1984). The hydrophobic
moment detects periodicity in protein hydrophobicity. *Proc. Natl. Acad.
Sci. USA*, 81(1), 140-144.
