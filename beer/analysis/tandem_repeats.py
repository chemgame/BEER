...
=============================
Tandem repeat, direct repeat, and low-complexity (compositional repeat)
detection for protein sequences.

Algorithms
----------
Tandem repeat detection:
    Classical k-mer extension algorithm scanning for exact consecutive
    repeats of unit lengths 2–8, as described in:
    Lander, E.S. et al. (2001). Initial sequencing and analysis of the human
    genome. *Nature*, 409, 860-921. (Section on tandem repeats.)

Low-complexity detection:
    Wootton, J.C. & Federhen, S. (1993). Statistics of local complexity in
    amino acid sequences and sequence databases. *Computers & Chemistry*,
    17(2), 149-163.
"""
